      ...
      data(){
        return{
          ...
          caibaoWorkList: [{
            ...
            title: '采宝发布工具',
            skill: 'node、git、oss',
            desc: '是一款由运行在node环境的命令行工具，集成了一键化发布、分支管理、tag标记等命令。',
            resolves:[
              `每个项目的发布流程都是大致相同的（分支切换、代码合并、资源打包、上传oss等），而且都是机械化的操作，因此和同事一起编写了这套工具，
              只需要一个命令就能让脚本自动去执行上述的操作流程，避免因人为失误而造成的发布问题，提高发布效率。`,
            ]
          },{
            title: '采宝会员系统',
            skill: 'Vue全家桶、微信应用',
